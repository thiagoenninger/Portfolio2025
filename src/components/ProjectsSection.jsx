...
const projects = [
  {
    id: 1,
    title: "Ignite Feed",
    description: "Recreating a social media feed page using React.",
  ...
  },
  {
    id: 2,
    title: "Pomodoro App",
    description: "Developing a pomodoro application using React.",
  ...
  },
  {
    id: 3,
    title: "To do List",
    description: "Creating a to do list application using React.",
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mt-12">
          <a
            ...
            href="https://github.com/thiagoenninger"
            target="_blank"
          >
